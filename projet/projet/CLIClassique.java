...
public class CLIClassique {
	...
	public static Configuration configuration(String... args) throws NumberFormatException {
		...
		try {
			while (i < args.length && ! finOptions) {
				...
				System.out.print("Veuillez saisir des nombres");
			} catch (ArrayIndexOutOfBoundsException e) {
				System.out.print("Veuillez renseigner toutes les options souhaitees");
			}
		return config;
	}
}
